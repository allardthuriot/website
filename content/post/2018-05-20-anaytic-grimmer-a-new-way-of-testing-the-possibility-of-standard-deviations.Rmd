---
title: 'Anaytic GRIMMER: a new way of testing the possibility of standard deviations'
...
[^1]: In practice, you should not limit yourselves to techniques such as GRIM or GRIMMER, but you should also try to generate possible values for the raw data via [SPRITE](https://peerj.com/preprints/26968v1/) or [CORVIDS](https://psyarxiv.com/7shr8/).
